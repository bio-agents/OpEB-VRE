...
function getAgents_List($status = 1) {
   if ($_SESSION['User']['Type'] == 3){
       $agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => $status, 'owner.license' => array('$ne' => "free_for_academics")), array('name' => 1, 'title' => 1, 'short_description' => 1, 'keywords' => 1))->sort(array('title' => 1));
	 } elseif($_SESSION['User']['Type'] == 0 || $_SESSION['User']['Type'] == 1) {
		 $agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => array('$ne' => 2)), array('name' => 1, 'title' => 1, 'short_description' => 1, 'keywords' => 1, 'status' => 1))->sort(array('title' => 1));
	 } else {
       $agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => $status), array('name' => 1, 'title' => 1, 'short_description' => 1, 'keywords' => 1))->sort(array('title' => 1));
   }
...
function getAgents_ListComplete($status = 1) {
   if ($_SESSION['User']['Type'] == 3){
       $agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => $status, 'owner.license' => array('$ne' => "free_for_academics")), array())->sort(array('title' => 1));
	 }elseif($_SESSION['User']['Type'] == 0 || $_SESSION['User']['Type'] == 1) {
	 		$agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => array('$ne' => 2)), array())->sort(array('title' => 1));
	 }else{
       $agents = $GLOBALS['agentsCol']->find(array('external' => true, 'status' => $status), array())->sort(array('title' => 1));
   }
...
function getFileTypes_List() {
	...
	$tls = $GLOBALS['agentsCol']->find(array('external' => true), array('name' => 1, 'input_files' => 1))->sort(array('name' => 1));
