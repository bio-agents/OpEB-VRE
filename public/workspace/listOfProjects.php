													...
													<tr>
														...
														<td>
															<a href="workspace/editProject.php?id=<?php echo $pr["_id"]; ?>">
																<i class="fa fa-pencil-square-o agenttips" aria-hidden="true" data-container="body" data-html="true" data-placement="top" data-original-title="<p align='left' style='margin:0'>Click here to edit this project.</p>"></i>
															</a>
															<a href="javascript:deleteProject('<?php echo $pr["_id"]; ?>', '<?php echo $pr["name"]; ?>')">
																<i class="fa fa-trash-o agenttips" aria-hidden="true" data-container="body" data-html="true" data-placement="top" data-original-title="<p align='left' style='margin:0'>Click here to delete this project.</p>"></i>
															</a>
														</td>
