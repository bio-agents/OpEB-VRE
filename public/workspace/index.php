...
// Agents list
if (isset($_REQUEST["agent"]) && $_REQUEST["agent"] != "") $dtlist = getAvailableDTbyAgent($_REQUEST["agent"]);
									...
									<div class="portlet light bordered">
										...
										<div class="portlet-body">
											...
											<form name="gesdir" action="workspace/workspace.php" method="post" enctype="multipart/form-data">
												...
												<input type="hidden" id="agentSelected" value="<?php echo $_REQUEST['agent']; ?>" />
