...
switch(pathinfo($_SERVER['PHP_SELF'])['filename']){
	...
	case 'input':?>
		...
		<?php break;
	case 'output': ?>
		<?php if(dirname($_SERVER['PHP_SELF']) == '/agents/agent_skeleton'){I ?>
		...
		<?php } elseif(dirname($_SERVER['PHP_SELF']) == '/agents/GMI_OD'){ ?>
			<script src="agents/GMI_OD/assets/js/output.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php } elseif (dirname($_SERVER['PHP_SELF']) == '/agents/TCGA_CD'){ ?>
